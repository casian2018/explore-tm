  ...
  <div class="flex items-center justify-center aling-middle">
    <div id="Security" v-if="selectedTab === 'Security'" class="mb-24">
      <div class="mx-[20%] mt-4">
        <h1 class="text-2xl font-bold mb-4 text-center">TOS & Privacy</h1>
        ...
        <section>
          ...
          <h2 class="text-2xl font-semibold mb-2" v-else>
          ...
          <p v-if="store.ro">
            ...
            de acord să respectați acești Termeni și Condiții.
          </p>
          <p v-else>
            By using the Explore TM mobile application ("the App"), you agree to
          ...
          <p v-if="store.ro">
            ...
            aplicația. Dacă aveți sub 18 ani, puteți utiliza aplicația numai cu
            implicarea unui părinte sau tutore.
          </p>
          <p v-else>
            Users must be at least 18 years old to use the App. If you are under
            18, you may only use the App with the involvement of a parent or
            guardian.
          </p>
          ...
          <p v-if="store.ro">
            ...
            a închiria biciclete sau scutere, a verifica sosirea autobuzului ori
            și navigați eficient.
          </p>
          <p v-else>
            Explore TM provides a platform for users to explore the city, rent
            bikes or scooters, check bus arrival times, and navigate
            efficiently.
          </p>
          ...
          <p v-if="store.ro">
            ...
            informațiilor contului lor. Sunteți de acord notifică imediat
            Explore TM cu privire la orice utilizare neautorizată a contului
            tău.
          </p>
          <p v-else>
            Users are responsible for maintaining the confidentiality of their
            account information. You agree to notify Explore TM immediately of
          ...
          <p v-if="store.ro">
            ...
            respecte toate legile locale de circulație în timp ce navighează în
            oraș. Comportamentul imprudent sau nesigur este strict interzis.
          </p>
          <p v-else>
            Users must use the App responsibly and adhere to all local traffic
            laws while navigating the city. Reckless or unsafe behavior is
            strictly prohibited.
          </p>
          ...
          <p v-if="store.ro">
            ...
            respecte regulile de circulație locale și să returneze vehiculul în
            conditie buna. Utilizatorii sunt responsabili pentru orice daune
            suferite în timpul perioadei de închiriere.
          </p>
          <p v-else>
            When renting bikes or scooters, users agree to follow local traffic
            rules and return the vehicle in good condition. Users are
          ...
          <p v-if="store.ro">
            ...
            date în timp real, atunci când sunt disponibile. Explore TM nu este
            responsabil pentru inexactități sau întârzieri cauzate de
            circumstanțe neprevăzute.
          </p>
          <p v-else>
            Bus arrival times provided in the App are based on real-time data
            when available. Explore TM is not responsible for inaccuracies or
          ...
          <p v-if="store.ro">
            ...
            și utilizarea informațiilor cu caracter personal sunt guvernate de
            noastre Politica de confidențialitate.
          </p>
          <p v-else>
            Explore TM values user privacy. The collection and use of personal
          ...
          <p v-if="store.ro">
            ...
            logo-urile, mărcile comerciale și informațiile, sunt proprietatea
            Explore TM și protejată de legile privind proprietatea intelectuală.
          </p>
          <p v-else>
            All content and materials available on the App, including logos,
            trademarks, and information, are the property of Explore TM and
          ...
          <p v-if="store.ro">
            Explore TM își rezervă dreptul de a închide sau suspenda contul fără
            notificare prealabilă pentru încălcări din acești Termeni și
            condiții.
          </p>
          <p v-else>
            Explore TM reserves the right to terminate or suspend your account
          ...
          <p v-if="store.ro">
            ...
            acuratețea, fiabilitatea sau disponibilitatea aplicației.
          </p>
          <p v-else>
            The App is provided "as is" without warranties of any kind, either
            expressed or implied. Explore TM does not guarantee the accuracy,
          ...
          <p v-if="store.ro">
            ...
            utilizarea de către dvs. a aplicației.
          </p>
          <p v-else>
      ...
      <section class="mt-8">
        ...
        <p class="text-lg" v-else>
          ...
          <p class="text-lg" v-if="store.ro">
            ...
            îmbunătățirea serviciilor noastre, furnizarea de conținut
            personalizat și analizarea comportamentului utilizatorilor pentru a
            îmbunătăți experiența utilizatorului.
          </p>
          <p class="text-lg" v-else>
            <strong class="font-bold text-xl">Data Usage:</strong> We use the
            collected data for various purposes, such as improving our services,
            providing personalized content, and analyzing user behavior to
            enhance the user experience.
          </p>
          <p class="text-lg" v-if="store.ro">
            Prin utilizarea aplicației Explore TM, confirmați că ați citit,
            înțeles și sunteți de acord cu confidențialitatea noastră Politică.
          </p>
          <p class="text-lg" v-else>
            <strong class="font-bold text-xl">Data Usage:</strong> We use the
            collected data for various purposes, such as improving our services,
